...
const IndividualTourDetail = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            setReviewBtnClicked(false); // Hide review form
            setLoading(true);
            axios.post("/tour/addreview", { tourId, rating: values.rating, content: values.review }, {
                ...
                if (res.data.message == "Review added") {
                    ...
                    setLoading(false);
                    toast.success("Review added", {  // Notification
                        position: "top-right",
                        autoClose: 5000,
                ...
                setLoading(false);
                toast.error("Failed to add review. Please try again later."); // Notification
            });
        },
    });

    // Update Formik rating field when local rating changes
    const handleRatingChange = useCallback((newRating) => {
        setRating(newRating);
        formik.setFieldValue('rating', newRating); // Update Formik rating
    }, [formik]);
        ...
        <>
            ...
            <div className="info-container container">
                ...
                <div className="action-buttons">
                    ...
                    <button onClick={() => setReviewBtnClicked(prev => !prev)} className='add-review-btn'>
                        Add review
                    </button>
                </div>
